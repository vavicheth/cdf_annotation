...
@section('content')
    ...
    @endcan
        ...
        <ul class="list-inline">
            <li><a href="{{ route('admin.documents.index') }}" style="{{ request('show_done') == 1 || request('show_all') == 1 || request('show_deleted') == 1 ? '' : 'font-weight: 700' }}">Active</a></li> |
            <li><a href="{{ route('admin.documents.index') }}?show_done=1" style="{{ request('show_done') == 1 ? 'font-weight: 700' : '' }}">Closed</a></li> |
            <li><a href="{{ route('admin.documents.index') }}?show_all=1"  style="{{ request('show_all') == 1 ? 'font-weight: 700':'' }}">@lang('quickadmin.qa_all')</a></li>
            @can('document_delete')
